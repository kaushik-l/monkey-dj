...
%                 [ cconfc, cphistd, ccerr ] = coherr( cmn(:,id), Jm, Jn, err, 1 ); (commenting 08/03/18)
%                 cerr(:,:,id ) = ccerr; (commenting 08/03/18)
%                 confc(id) = cconfc; (commenting 08/03/18)
                %size(cphistd), size(phistd)
                
%                 phistd(:,id) = cphistd; % frequencies x iChPairs (commenting 08/03/18)
