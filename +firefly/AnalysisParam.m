...
lfp_filtorder=4                 : int
lfp_freqmin=0.5                 : float             # min frequency (Hz)
lfp_freqmax=75                  : float             # max frequency (Hz)
...
classdef AnalysisParam < dj.Lookup
    properties
        contents = {
            1,...
            ...
            0.05,50,50,50,0.15,5,3,0.05,0.5,0.5,0.5,0.5,0.1,4,10,1,0.75,4,10,50,5,100,...
            ...
            4,0.5,75,[1 1],1,[1.5 1.5],0.5,0.5,[6 12],8.5,[12 20],18.5,[-1 1],1,0.05:0.05:2,25,...
            ...
