%{
# Eye movement across firefly_OFF trials (tracking index, saccades)
-> firefly.Behaviour
-> firefly.Event
...
classdef StatsEyeInvisibletarg < dj.Computed
    methods(Access=protected)
        function makeTuples(self,key)
            ...
            stats = fetch(firefly.StatsBehaviourInvisibletarg &...
                ['session_id = ' num2str(key.session_id)] & ['monk_name = ' '"' key.monk_name '"'],'*');
