...
stats.tuning_vpval = tuning_v.tuning.rate.mu;
stats.tuning_w = tuning_w.tuning.stim.mu;
stats.tuning_wrate = tuning_w.tuning.rate.mu;
stats.tuning_wpval = tuning_w.tuning.rate.mu;
...
stats.tuning_ehpval = tuning_eh.tuning.rate.mu;
stats.tuning_ev = tuning_ev.tuning.stim.mu;
stats.tuning_evrate = tuning_ev.tuning.rate.mu;
stats.tuning_evpval = tuning_ev.tuning.rate.mu;
